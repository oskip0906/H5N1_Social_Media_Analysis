...
def plot_bar_chart(data, title, file):
...
for file in files:
    ...
    plot_bar_chart(data, state.capitalize(), f'graphs/outbreaks_monthly_by_state/{state}.png')

# Plot for the combined data
data = pd.read_csv('csv_files/outbreaks_monthly.csv')
plot_bar_chart(data, 'Outbreaks Monthly', 'graphs/outbreaks_monthly_graph.png')